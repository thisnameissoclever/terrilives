"""Render a stove candidate with the accepted camera, lights and toon shader."""
import hashlib
import json
import math
...
def run(directory):
    ...
    inputs = [Path(__file__),BASE/'stove_model.py',BASE/'stove_geometry.py',
    ...
    try:
        ...
        root = bpy.data.objects.new('STOVE_MODEL_ROOT',None)
        ...
        model = directory/'stove-authoring.blend'
