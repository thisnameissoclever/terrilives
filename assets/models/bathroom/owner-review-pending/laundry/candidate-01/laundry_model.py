...
def build(root):
    ...
    for label, base in (('Washer', .08), ('Dryer', .92)):
        ...
        box(label+' indicator', (.13, -.408, base+.716), (.16, .010, .044), glass, root, .004)
        cylinder(label+' dial', (-.19, -.4, base+.716), (-.19, -.437, base+.716), .04, rubber, root)
        box(label+' dial marker', (-.19, -.438, base+.738), (.007, .008, .017), front, root, .002)
    ...
    box('Washer detergent drawer', (.05, -.408, .794), (.29, .012, .077), front, root, .005)
