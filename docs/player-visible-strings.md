...
| Selling | Sell; Sell for {amount}; Selling…; {name} sold.; The sale could not be sent.; Delete or Backspace sells, in the Furniture tool's keyboard help line | `web/index.html`, `web/src/ui/builder.ts`, `web/src/ui/builder-controls.ts` |
