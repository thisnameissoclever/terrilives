...
**Not proven here.** Saving and reloading a painted house was not done by hand in the browser; the round trip is covered by tests. Nobody walked on the new carpet, because a covering changes nothing but how a tile is drawn. A phone width was not tested. The three coverings are the one floor sprite under a colour shift, so none of them reads as boards or as carpet in the way art would: that is [T-floor-art].
