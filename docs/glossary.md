...
| **window** | A wall line nobody walks through and the day comes through: it stops people exactly as a wall does, passes **sky exposure** as a doorway does, and stops a lamp's pool as a wall does. Fitted with Window in the Walls tool. Drawn as the wall panel it stands in, washed pale blue, until there is window art. |
