...
and emissive strength, a clock-driven ambient cycle, and a deterministic
two-pixel walking lift. The selection ring remains planted and reduced motion
disables ornamental lift and pins ambient light to noon. There is no borrowed
pack art, live 3D mesh pipeline, external character rig, or imported animation
library in the shipped alpha.
